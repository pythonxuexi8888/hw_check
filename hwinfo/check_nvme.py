...
nvme_report_file = sys.path[0] + '/nvme_report.csv'
...
for nvme_dev in nvme_devs:
    ...
    vendor_product_name = _dev_info['ProductName']
    ...
    result += ','.join([basic_info,vendor_product_name.replace(',', ''),life,numa_node,interrupt_node]) + '\n'
